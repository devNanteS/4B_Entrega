...
(3, 'PIX'), -- Transferência Imediata online
(4, 'Dinheiro'); -- Tranferência física
...
-- Insere 5 endereços (necessários para os clientes)
...
-- Insere 5 CNHs (necessárias para os clientes)
...
-- Insere 5 clientes, associando os endereços e CNHs criados
...
-- Insere 5 funcionários, associando os cargos
...
-- Insere 5 modelos de veículos, associando marcas e categorias
...
-- Bloco 3: Entidade principal "Veiculo"

-- Insere 5 veículos da frota, associando modelos e status
...
-- Bloco 4: Registros de Atividades (Locações, Manutenções)
...
-- Insere 5 locações (misturando ativas e finalizadas)
